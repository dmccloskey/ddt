"use strict";
function ddt_svg_horizontalBoxAndWhiskersPlot2d_02() {
...
ddt_svg_horizontalBoxAndWhiskersPlot2d_02.prototype = Object.create(ddt_svg.prototype);
ddt_svg_horizontalBoxAndWhiskersPlot2d_02.prototype.constructor = ddt_svg_horizontalBoxAndWhiskersPlot2d_02;
ddt_svg_horizontalBoxAndWhiskersPlot2d_02.prototype.make_svg = function(data_I,parameters_I){
    ...
    this.ddtsvg.render = function () {
        ...
        if (typeof(this.data2keymap.xdata)!=="undefined"){
        	this.add_horizontalBoxAndWhiskersData2();
        	this.add_horizontalBoxAndWhiskersData2_points(parameters_I.svgdata2pointsradius);
        	this.add_horizontalBoxAndWhiskersPointsData2tooltipandfill();
        } else if (typeof(this.data1keymap.xdata)!=="undefined"){
        	this.add_horizontalBoxAndWhiskersData1_points();        	
        };
