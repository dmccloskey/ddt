...
function ddt_svg_indentedtreelayout2d_01() {
// 	treelayout
// 	DESCRIPTION:
// 	generic treelayout
// 	INPUT:
...
ddt_svg_indentedtreelayout2d_01.prototype = Object.create(ddt_svg.prototype);
ddt_svg_indentedtreelayout2d_01.prototype.constructor = ddt_svg_indentedtreelayout2d_01;
ddt_svg_indentedtreelayout2d_01.prototype.make_svg = function(data_I,parameters_I){
    ...
    this.ddtsvg.render = function () {
        ...
        this.set_svgstyle();
        this.set_indentedTreeLayoutBarWidthAndHeight(parameters_I.svgbarwidth,parameters_I.svgbarheight);
		this.set_treelayouttree(
			parameters_I.svgwidth,
			parameters_I.svgheight,
			0,20);
        ...
        this.update_indentedtreelayout();
    	this.set_zoom();
    	this.add_zoom();
    	this.set_drag();
    	this.add_drag();
